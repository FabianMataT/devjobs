    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    @if (auth()->user()->rol === 2)
                        <a class="mr-2 w-7 h-7 bg-gray-500 hover:bg-gray-600 rounded-full text-white flex flex-col justify-center items-center text-sm font-bold" href="{{route('notificaciones')}}">
            ...
            @if (auth()->user()->rol === 2)
                ...
                <div class="flex gap-2 items-center p-3">
                    ...
                    <p class="text-gray-400 font-bold">
                        @choice('Noticacion|Notificaciones', auth()->user()->unreadNotifications->count())
                    </p>
                </div>
            @endif
